...
const JobPostingPreview = ({ formData, setIsPreview }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-purple-50/20 py-8 px-4 sm:px-6 lg:px-50">
        ...
        <div className="mb-8 backdrop-blur-sm bg-white/80 border border-white/20 shadow-xl rounded-2xl px-6 pt-6">
          ...
          <div className="relative bg-white px-0 pb-8 mt-8 border-b border-gray-100">
            <div className="relative z-10">
              ...
              {/* Tags */}
              <div className="flex flex-wrap gap-3 mt-12 md:mt-0">
          ...
          <div className="px-0 pb-8 space-y-8">
            <div className="relative overflow-hidden bg-gradient-to-r from-emerald-50 to-teal-50 border border-emerald-100 p-6 rounded-2xl shadow-md">
              {/* Decorative circle */}
              <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-emerald-200/20 to-teal-200/10 rounded-full -translate-y-1/2 translate-x-1/2 pointer-events-none" />

              <div className="relative z-10 flex items-center justify-between">
                {/* Left: Icon */}
                <div className="p-3 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-xl shadow-sm">
                  <DollarSign className="h-6 w-6 text-white" />
                </div>

                {/* Right: Compensation Text */}

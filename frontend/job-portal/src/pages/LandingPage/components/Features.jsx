   ...
   <section className=' py-20 bg-white relative overflow-hidden'>
    <div className='container mx-auto px-4 relative z-10'>
      <div className='text-center mb-16'>
        <h2 className='text-4xl md:text-5xl font-bold text-gray-900 mb-6'> Everything You need to <span className='block bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent'>Succeed</span></h2>
              ...
              <div key={index} className='group flex items-start space-x-4 p-6 rounded-2xl hover:bg-blue-50 transition-all duration-300 cursor-pointer' >
                <div className='flex-shrink-0 w-12 h-12 bg-blue-100 rounded-xl flex items-center justify-center group-hover:bg-blue-200 transition-colors'>
                  ...
                  <div>
                    ...
                    <p className='text-gray-600 leading-relaxed'> {feature.descripton}</p>
                    </div> 
                    </div>
            ))}
            </div>
              ...
              <div className='text-center mb-12'>
                ...
                <div className='space-y-8'>
                  {employerFeatures.map((feature, index) =>(
                    <div key={index}
                    className='group flex items-start space-x-4 p-6 rounded-2xl hover:bg-purple-500 transition-all duration-300 cursor-pointer'>

...
const JobPostingForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.status === 200 || response.status === 201) {
        toast.success(
          jobId ? "Job Updated Successfuly!" : "Job Posted Successfuly"
        );
        setFormData({
          jobTitle: "",
          location: "",
  ...
  const validateForm = (formData) => {
    ...
    if  (!formData.category) {
      errors.jobTitle = "Please select a category";
    }

    if  (!formData.jobType) {
      errors.jobTitle = "Please select a job type";
    }

    if  (!formData.description.trim()) {
      errors.jobTitle = "Job description is required";
    }

    if  (!formData.requirements.trim()) {
      errors.jobTitle = "Job requirements is required";
    }
        ...
        <div className='max-w-4xl mx-auto'>
          <div className='bg-white shadow-xl rounded-2xl p-6'>
            ...
            <div className='space-y-6'>
              ...
              helperText="Include key responsibilities, day-today tasks, and what is exciting abouth this role."
              required />
              ...
              <div className='space-y-2'>
                ...
                <div className='pt-2'>
                  ...
                  className='w-full flex itms-center justify-center px-4 py-3 border border-transparent text-base font-medium rounded-lg text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-offset-2 focus:ring-blue-500 disabled:bg-gray-400 disabled:cursor-not-allowed outline-none transition-all duration-200'>
                    {isSubmitting ? (
                      <>

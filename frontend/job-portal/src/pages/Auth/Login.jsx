...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const { token, _id, name, email, avatar, role, companyName, companyDescription, companyLogo, resume } = response.data;

// Pass only the user object to context
login(
  { _id, name, email, avatar, role, companyName, companyDescription, companyLogo, resume },
  token
)
        ...
        <form onSubmit={handleSubmit} className='space-y-6'>
          ...
          <div>
            ...
            <div className='relative'>
              ...
              className={`w-full pl-10 pr-4 py-3 rounded-lg border ${formState.errors.email ? 'border-red-500' : 'border-gray-300'} focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors`}
          ...
          <div>
            ...
            <div className='relative'>
              ...
              onChange={handleInputChange}
              className={`w-full pl-10 pr-12 py-3 rounded-lg border ${formState.errors.password ? 'border-red-500' : 'border-gray-300'} focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors`}
